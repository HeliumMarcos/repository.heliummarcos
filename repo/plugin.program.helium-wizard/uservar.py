...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Helium[/B][/COLOR]Wizard'
BUILDERNAME = 'HeliumWizard'
EXCLUDES = [ADDON_ID, 'repository.heliummarcos']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://heliummarcos.com.br/addons/Builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Helium[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
THEME5 = u'[COLOR {color1}]Tema Atual:[/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)

# Message for Contact Page
# Enable 'Contact' menu item 'Yes' hide or 'No' dont hide
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Obrigado por escolher HeliumWizard.'
...
REPOID = 'repository.heliummarcos'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://raw.githubusercontent.com/HeliumMarcos/repository.heliummarcos/master/repo/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/HeliumMarcos/repository.heliummarcos/master/repo/zips/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Helium[/B][/COLOR]Wizard'
