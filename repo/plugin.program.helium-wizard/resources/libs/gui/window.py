...
def show_build_prompt():
    class BuildPrompt(xbmcgui.WindowXMLDialog):
        ...
        def __init__(self, *args, **kwargs):
            ...
            self.msg = "Atualmente, nenhuma versão de {0} está instalada..\n\nSelecione 'Menu de Builds' para instalar uma versão da comunidade fornecida por nós ou 'Ignorar' para nunca mais ver esta mensagem.\n\nObrigado por escolher {1}.".format(CONFIG.ADDONTITLE, CONFIG.ADDONTITLE)
